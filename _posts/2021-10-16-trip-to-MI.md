...
<p>Click here for dojo get test: --<a target="_blank" href="../minima/assets/dojodemo.html"></a></p>
...
<iframe src="/minima/assets/mapAnimate.html"
    sandbox="allow-same-origin allow-scripts"
    width="100%"
    height="500"
    scrolling="no"
...
<iframe src="/minima/assets/mapGeoJSON.html"
    sandbox="allow-same-origin allow-scripts"
    width="100%"
    height="500"
    scrolling="no"
...
<script src="https://embed.github.com/view/geojson/WayneWhitley/minima/master/assets/quadrats.json"></script>
